...
<div class="container">
	<div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <p class="lead">Descripcion area designasiones</p>
                <p>El area de designaciones se encarga de ...</p>
                 <h1> Usted puede dirigirse con:</h1>  
                <p>Sandra chao,Mabel Renini,Cesar Caltariano,Patricia digidia,Anahi Lopez,Karina Juarez,Gizel Correa o Norma Roca en el primer piso,su contacto es 4253 3367</p> 
